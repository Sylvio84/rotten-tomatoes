...
class User implements UserInterface
{
     ...
     * @Assert\NotBlank( message = "Veuillez saisir votre pseudonyme.")
     * @Assert\Length(min=3)
     */
    private $name;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotBlank( message = "Veuillez ajouter une image pour votre profil.")
     * Assert\Url
     */
    private $avatar;
    ...
    public function hasRate(Movie $movie): bool
    {
        ...
        foreach ($ratings as $rating) {
            if ($rating->getMovie() == $movie) return true;
        }
        return false;
    }
}
